<?php
    ...
    $waktu = $_POST["waktu"];
     ...
     function registerUser() {
        ...
        $statement = mysqli_prepare($connect, "INSERT INTO absen_ai (tanggal, name, nim, waktu) VALUES (NOW(), '$name', '$nim', NOW() )");
    ...
    function usernameAvailable() {
        global $connect, $nim;
        $statement = mysqli_prepare($connect, "SELECT * FROM krs_ai WHERE nim = '$nim'"); 
